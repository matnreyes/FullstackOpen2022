describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    ...
    it('a new blog can be created', function () {
      ...
      cy.contains('Blog succesfully added').should(
        'have.css',
        'color',
        'rgb(0, 128, 0)'
      )
    ...
    it('user can like blog', function () {
      cy.contains('Test blog').should('contain', 'likes: 0').as('theBlog')

      cy.get('@theBlog').contains('expand').click()
    ...
    describe('user can delete', function () {
      it('blog they wrote', function () {
        cy.contains('Test blog').contains('expand').click()

        cy.contains('delete').click()

        cy.contains('Succesfully deleted Test blog').should(
          'have.css',
          'color',
          'rgb(0, 128, 0)'
        )
      ...
      it('user can only delete blog they posted', function () {
        ...
        cy.contains('Other Blog').should('not.contain', 'delete')
      })
    })
  })
  ...
  describe('Blogs', function () {
    ...
    it('are ordered by descending likes', function () {
      ...
      cy.get('@lastBlog').should('contain', 'blog3').contains('expand').click()
