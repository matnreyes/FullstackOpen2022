...
const getNonEmbeddedLandingPageHTML = (cdnVersion, config, apolloServerVersion) => {
  ...
  <body style="margin: 0; overflow-x: hidden; overflow-y: hidden">
    ...
    ${config.embed
                        ? 'graphRef' in config && config.graphRef
                            ? (0, getEmbeddedHTML_js_1.getEmbeddedExplorerHTML)(version, config, apolloServerVersion)
                            : !('graphRef' in config)
                                ? (0, getEmbeddedHTML_js_1.getEmbeddedSandboxHTML)(version, config, apolloServerVersion)
